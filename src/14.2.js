...
function application() {
  ...
  let restingY = Number.MIN_SAFE_INTEGER
  let count = 0
  do {
    restingY = dropOneGrainOfSand(extents.bottom, sparseGrid)
    count++
  } while (restingY > 0)

  renderGrid(sparseGrid, { ...extents, bottom: extents.bottom + 4 })
  console.log(restingY, count)
}
